...
namespace TestProject
{
    class Admin:SystemUser
    {
        ...
        public void CreateProfile(out SystemMessages msg)  {
            ...
            dic.Add("@Status", null);
           var TestAdmin = db.Search(this.GetType(), dic).Cast<Admin>().ToList();
        ...
        public List<Admin> Search(Dictionary<string,object> dic) {
           return  db.Search(this.GetType(), dic).Cast<Admin>().ToList();
        }
